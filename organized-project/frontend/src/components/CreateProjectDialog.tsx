...
export default function CreateProjectDialog({ 
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="bg-card-bg border border-white/10 max-w-2xl w-[95vw] max-h-[85vh] overflow-y-auto mx-auto my-4 sm:my-8" aria-describedby="dialog-description">
        <DialogHeader>
