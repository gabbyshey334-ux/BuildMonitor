...
export function BudgetCostsSection({ data }: { data?: BudgetCostsSectionData }) {
  ...
  return (
    <Card className="bg-card border-border col-span-1 lg:col-span-2">
      <CardHeader>
        <CardTitle className="text-foreground font-bold">Budget & Costs</CardTitle>
      </CardHeader>
      <CardContent>
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="text-center p-4 rounded-lg border border-border bg-card">
              ...
              <p className="text-2xl font-bold text-foreground">UGX {totalBudget.toLocaleString()}</p>
            </div>
            <div className="text-center p-4 rounded-lg border border-border bg-card">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div>
              <h3 className="text-lg font-semibold mb-3 text-foreground">Budget Breakdown</h3>
              {breakdown.length > 0 ? (
                <>
            ...
            <div>
              <h3 className="text-lg font-semibold mb-3 text-foreground">Budget vs. Actual Spend</h3>
              {vsActual.length > 0 ? (
                <>
                  <ResponsiveContainer width="100%" height={300}>
          ...
          <div>
            <h3 className="text-lg font-semibold mb-3 text-foreground">Cumulative Costs Over Time</h3>
