  ...
  <Card className={`cursor-pointer hover:shadow-md transition-shadow bg-card border-border ${
    ...
    <CardContent className="p-3">
      <div className="flex items-start justify-between mb-2">
        <h5 className="font-medium text-sm font-heading text-foreground">{issue.title}</h5>
        <Badge
    ...
    <Card className="bg-card border-border">
      <CardHeader>
        <div className="flex items-center justify-between">
          <CardTitle className="font-heading text-foreground font-bold">Issues & Risks</CardTitle>
          <Button size="sm" className="text-foreground border-border hover:bg-muted/60">
      ...
      <CardContent>
        ...
        <div className="grid grid-cols-4 gap-4 mb-6">
          ...
          <div className="text-center">
            <p className="text-3xl font-bold text-foreground font-heading">{openIssues}</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {/* To Do */}
          <div>
            <h4 className="font-semibold mb-3 flex items-center gap-2 font-heading text-foreground">
        ...
        <div className="mt-6">
          <h4 className="font-semibold mb-3 font-heading text-foreground">Issue Types</h4>
              ...
              {issueTypes.map(type => (
                <div key={type.type} className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    ...
                    />
                    <span className="text-sm font-body text-foreground">{type.type}</span>
                  </div>
                  <span className="font-medium font-body text-foreground/80">{type.count} ({type.percentage}%)</span>
                </div>
              ))}
            </div>
          </div>
