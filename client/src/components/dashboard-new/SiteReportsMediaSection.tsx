    ...
    <Card className="bg-card border-border">
      <CardHeader>
        <div className="flex items-center justify-between">
          <CardTitle className="font-heading text-foreground font-bold">Site Reports & Media</CardTitle>
          <div className="flex items-center gap-2">
            <Badge variant="secondary" className="font-body text-foreground/80">{recentPhotos.length} photos</Badge>
            <Badge variant="secondary" className="font-body text-foreground/80">{dailyLogsThisWeek} logs this week</Badge>
          </div>
        </div>
      </CardHeader>
      <CardContent>
        ...
        <div className="grid grid-cols-3 gap-4 mb-6">
          <div className="text-center p-4 rounded-lg border border-border bg-card">
            <p className="text-2xl font-bold font-heading text-foreground">{dailyLogsThisWeek}</p>
            <p className="text-xs text-muted-foreground font-body">Daily Logs This Week</p>
          </div>
          <div className="text-center p-4 rounded-lg border border-border bg-card">
            <p className="text-2xl font-bold font-heading text-foreground">{photosUploaded}</p>
        ...
        <div>
          <h4 className="font-semibold mb-3 font-heading text-foreground">Recent Site Photos</h4>
          ...
          <Button variant="outline" className="w-full mt-4 font-body text-foreground border-border hover:bg-muted/60">
