    ...
    <>
      ...
      >
        ...
        <div className="flex flex-col items-center shrink-0 w-3 pt-1">
          <div className="w-2.5 h-2.5 rounded-full bg-[#93C54E] shadow-[0_0_8px_rgba(0,188,212,0.8)] ring-4 ring-background z-10 shrink-0" />
          {!isLast && (
            <div className="w-0.5 flex-1 bg-gradient-to-b from-[#93C54E] to-[#93C54E]/20 min-h-[48px] mt-1 rounded-full" />
          )}
        </div>
        ...
        <div className="flex-1 min-w-0 py-4 pr-1 sm:pr-3 group">
          <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-2">
            <div className="min-w-0 flex-1">
              <div className="inline-flex items-center px-2.5 py-0.5 rounded-full bg-[#93C54E]/10 text-[#93C54E] text-[10px] sm:text-xs font-bold uppercase tracking-wider mb-2">
                {typeLabel}
              </div>
              ...
              {entry.amount != null &&
                ...
                Number(entry.amount) > 0 && (
                  <p className="text-[#93C54E] font-mono tabular-nums font-bold text-base mt-1">
      ...
      <div className="w-full min-h-[60vh] flex items-center justify-center">
        <div className="text-center max-w-md space-y-6">
          <div className="w-20 h-20 rounded-full bg-[#93C54E]/10 flex items-center justify-center mx-auto ring-1 ring-[#93C54E]/20">
            <Calendar className="w-10 h-10 text-[#93C54E]" />
          </div>
  ...
  return (
    <div className="w-full min-w-0 max-w-full overflow-x-hidden text-foreground font-sans">
      <div className="w-full space-y-6 md:space-y-8">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            <Button
              ...
              variant="outline"
              size="icon"
              className="rounded-full w-10 h-10 bg-card/50 backdrop-blur-sm border-border text-muted-foreground hover:text-[#93C54E] hover:border-[#93C54E]/50 hover:bg-[#93C54E]/10 transition-all shadow-sm"
            >
        ...
        {/* Stats Row */}
        <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4">
          <div className="bg-gradient-to-br from-card to-card/50 border border-border rounded-2xl p-4 sm:p-6 relative overflow-hidden group hover:border-[#93C54E]/30 hover:shadow-lg hover:shadow-[#93C54E]/5 transition-all duration-300 min-w-0">
            <div className="flex items-center gap-3 mb-3 min-w-0">
              <div className="p-2.5 rounded-xl bg-muted text-muted-foreground group-hover:bg-[#93C54E]/10 group-hover:text-[#93C54E] transition-colors shrink-0">
          ...
          <div className="bg-gradient-to-br from-card to-card/50 border border-border rounded-2xl p-4 sm:p-6 relative overflow-hidden group hover:border-[#93C54E]/30 hover:shadow-lg hover:shadow-[#93C54E]/5 transition-all duration-300 min-w-0">
            <div className="absolute -top-4 -right-4 p-4 opacity-5 group-hover:opacity-10 group-hover:scale-110 transition-all duration-500">
              <Users className="w-32 h-32 text-[#93C54E]" />
            </div>
            <div className="flex items-center gap-3 mb-3 relative z-10 min-w-0">
              <div className="p-2.5 rounded-xl bg-[#93C54E]/10 text-[#93C54E] shrink-0">
            ...
            <div className="flex flex-col sm:flex-row sm:flex-wrap sm:items-center sm:justify-between gap-3 p-4 border-b border-border">
              <div className="flex items-center justify-center sm:justify-start gap-2 flex-1 min-w-0">
                <button
                  ...
                  className="p-2 rounded-xl bg-muted/50 hover:bg-[#93C54E]/10 text-muted-foreground hover:text-[#93C54E] transition-all shrink-0"
                ...
                <button
                  ...
                  className={cn(
                    ...
                    isToday
                      ...
                      : 'bg-muted/50 hover:bg-[#93C54E]/10 text-muted-foreground hover:text-[#93C54E]',
                  )}
                  aria-label="Next day"
                >
              ...
              <div className="flex items-center justify-center sm:justify-end gap-3 flex-wrap">
                <Button
                  ...
                  className={cn(
                    'rounded-lg border-[#93C54E] text-[#93C54E] bg-transparent hover:bg-[#93C54E]/10 hover:text-[#93C54E]',
                    ...
                    <div className="space-y-2">
                      {dailyLog.worker_count != null && dailyLog.worker_count > 0 && (
                        <div className="flex items-center gap-2.5 text-sm text-muted-foreground">
                          <div className="p-1.5 rounded-lg bg-[#93C54E]/10 text-[#93C54E] shrink-0">
                  ...
                  <div key={entry.id} className="bg-muted/50 rounded-lg p-3 border border-border/50">
                    ...
                    <div className="mb-2">
                      <select
                        ...
                        className="w-full px-2 py-1.5 rounded bg-card border border-border text-foreground text-sm focus:outline-none focus:ring-2 focus:ring-[#93C54E]"
                      >
                    ...
                    <input
                          ...
                          className="w-full px-2 py-2 rounded bg-card border border-border text-foreground text-sm focus:outline-none focus:ring-2 focus:ring-[#93C54E]"
                        />
                      ...
                      >
                        <input
                          ...
                          className="w-full px-3 py-2 rounded bg-card border border-border text-foreground text-sm focus:outline-none focus:ring-2 focus:ring-[#93C54E] placeholder:text-muted-foreground"
                        />
                      ...
                      {entry.activityType === 'labor' && (
                        <div className="col-span-3">
                          <input
                            ...
                            className="w-full px-2 py-2 rounded bg-card border border-border text-foreground text-sm focus:outline-none focus:ring-2 focus:ring-[#93C54E] placeholder:text-muted-foreground"
                          />
                        </div>
                      )}
                    ...
                    {(entry.activityType === 'photo' || (entryPhotos[entry.id] && entryPhotos[entry.id].length > 0)) && (
                      <div className="mt-2">
                        <button
                          ...
                          className="flex items-center gap-2 text-sm text-[#93C54E] hover:text-[#7ab03e] bg-[#93C54E]/10 hover:bg-[#93C54E]/20 px-3 py-2 rounded-lg transition-colors w-full justify-center"
                        >
